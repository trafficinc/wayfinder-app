...
<main>
    <section class="hero">
        <div class="card">
            ...
            <div class="cta-row">
                ...
                <a class="button button-secondary" href="https://github.com/trafficinc/wayfinder">View Source</a>
            </div>
    ...
    <section class="grid">
        <article class="card feature-card">
            <h2>HTTP Core</h2>
            <p>Routes, middleware, request objects, validation, CSRF protection, sessions, and responses all run through one explicit kernel lifecycle.</p>
        </article>
        <article class="card feature-card">
            <h2>Builder-First Data</h2>
            <p>Use `DB::table(...)`, migrations, rollback/refresh commands, and database-backed validation without requiring an ORM.</p>
        </article>
        <article class="card feature-card">
            <h2>App-Owned Starter</h2>
            <p>This page keeps its CSS inline on purpose, so the first screen is easy to replace or restyle without hunting through shared assets.</p>
        </article>
    </section>
    ...
    <section class="grid" style="grid-template-columns:1.2fr .8fr;">
        <article class="card demo-card">
            ...
            <p>This form exercises CSRF protection, validation, flash data, old input, and redirect-back behavior on the default starter route.</p>
